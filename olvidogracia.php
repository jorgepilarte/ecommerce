	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-8 text-left">
				<div class="well text-center" id="contenedor">
				<h2>En breve llegara tu clave de acceso</h2>
				<p>Revisa tu buzon y cambia la clave de acceso</p>
