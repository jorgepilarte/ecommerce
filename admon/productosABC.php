		...
		$desc_escapado = escapaCadena($descripcion);
	 	...
	 	if ($id="") {
			...
			if(mysqli_query($conn, $sql)){
				...
				echo "Registro no se ha insertado" .$sql;
			}
	}
}
...
<head>
	...
	<script>
		window.onload = function() {
			...
			<?php if($m=="S"){ ?>
			document.getElementById("daralta").onclick = function(){
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="menu">
				<ul class="nav navbar-nav">
					<li class="active"><a href="productosABC.php.php">Productos</a></li>
				</ul>
	...
	<div class="container-fluid text-center">
		<div class="row content">
			<div class="col-sm-2 sidenav">
				<?php if($m=="S") {  ?>
				<label for="daralta"></label>
				<input type="button" name="daralta" id="daralta" value="Dar de alta producto" class="btn btn-info" role="button">
				<?php } ?>
			</div>
			<div class="col-sm-8 text-left">
				...
				<form action="productosABC.php" method="post" enctype="multipart/form-data">
					<div class="form-group text-left">
						...
						<input type="text" name="nombre" id="nombre" class="form-control"  placeholder="Escriba su nombre" value="<?php if(isset($nombre)){ echo $nombre;} ?>">
					</div>
					<div class="form-group text-left">
